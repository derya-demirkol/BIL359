...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $kulad = trim($_POST['kadi']);
    
    // --- DEĞİŞİKLİK BURADA ---
    // ŞİFREYİ ARTIK HASH'LEMİYORUZ, DİREKT ALIYORUZ
    $sifre_düz_yazi = trim($_POST['sifre']);
    // --- DEĞİŞİKLİK BURADA BİTTİ ---

    // SQL SORGUSUNU DA DÜZ YAZIYA GÖRE DEĞİŞTİRDİK
    $sql = "SELECT * FROM kullanicilar WHERE kulad='$kulad' AND sifre='$sifre_düz_yazi'";
    $res = $conn->query($sql);
  ...
  <div class="form-card">
    <form method="post">
      ...
      <div class="form-actions">
        ...
        <a href="kayit-ol.html" class="btn">Kayıt Ol</a>
        <a href="iletisim.html" class="btn">Şifremi Unuttum</a>
      </div>
